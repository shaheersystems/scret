...
function Sidebar() {
  return (
    <div className='h-screen w-20 border sticky top-0 flex flex-col items-center justify-between'>
      <div>
        <a href='/' className=''>
          <span className='text-4xl font-black font-serif flex items-center justify-center'>
            <svg
              width={70}
              height={70}
              fill='black'
            ...
            >
              ...
              <path d='M15 16c1.105 0 2-1.79 2-4s-.895-4-2-4-2 1.79-2 4 .895 4 2 4Z' />
              <path d='M20 16c.552 0 1-1.79 1-4s-.448-4-1-4-1 1.79-1 4 .448 4 1 4Z' />
            </svg>
          </span>
        </a>
      </div>
